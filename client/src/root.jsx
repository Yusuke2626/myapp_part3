...
export default class App extends React.Component {
  ...
  clickFuncMessageArea(e){
    this.setState({messageAreaOpen:true,myProfileOpen:false,lookForPeopleOpen:false,likesToUserId:e})
    console.log('clickmessage',this.state.likesToUserId);
  }
  handleClick(){
  ...
  render() {
      ...
      return(
        <div>
          ...
          <div className='contents2' >
            < MyProfile clickMessageArea={(e)=>{this.clickFuncMessageArea(e);}}/>
          </div>
        </div>
    );
    ...
    return(
      ...
      var profile = user[1];
      var user = user[0];
      console.log(this.state.likesToUserId);
      return(
        <div>
          <h3>share shareでルームメイトを見つけよう </h3>
          <h4 style={cursorstyle} onClick={()=>{this.handleClick()}}> my_profile</h4>
          <div className='contents2' >
            ...
            <Message likeUserId={this.state.likesToUserId} />
          </div>
        </div>
      )
    }
        ...
        var index_num = 999;
        var partner_block = [];
        var userProfile = allProfile.filter(p=>p.user_id===user.id)
